...
describe('integration', () => {
  ...
  it('multiple consumers all receive the same event', () => {
    ...
    function ConsumerA() {
      useEvent('toast:show', handlerA, bus);
      return null;
    }
    function ConsumerB() {
      useEvent('toast:show', handlerB, bus);
      return null;
    }
    function ConsumerC() {
      useEvent('toast:show', handlerC, bus);
      return null;
    }
  ...
  it('unmounting one consumer does not affect others', () => {
    ...
    function Stayer() {
      useEvent('toast:show', stayHandler, bus);
      return null;
    }
    function Leaver() {
      useEvent('toast:show', leaveHandler, bus);
      return null;
    }
  ...
  it('different events are isolated from each other', () => {
    ...
    function ToastConsumer() {
      useEvent('toast:show', toastHandler, bus);
      return null;
    }
    function CounterConsumer() {
      useEvent('counter:increment', counterHandler, bus);
      return null;
    }
  ...
  it('separate bus instances are fully isolated', () => {
    ...
    function ConsumerA() {
      useEvent('toast:show', handlerA, busA);
      return null;
    }
    function ConsumerB() {
      useEvent('toast:show', handlerB, busB);
      return null;
    }
  ...
  it('useAnyEvent and useEvent both fire on the same emit', () => {
    ...
    function SpecificConsumer() {
      useEvent('toast:show', specificHandler, bus);
      return null;
    }
    function AnyConsumer() {
      useAnyEvent(anyHandler, bus);
      return null;
    }
  ...
  it('createBusContext Provider isolates from direct-bus consumers', () => {
    ...
    function ContextConsumer() {
      useCtxEvent('toast:show', contextHandler);
      return null;
    }
    function DirectConsumer() {
      useEvent('toast:show', directHandler, directBus);
      return null;
    }

    render(
      <div>
        <Provider bus={contextBus}>
          <ContextConsumer />
        </Provider>
        <DirectConsumer />
      </div>,
